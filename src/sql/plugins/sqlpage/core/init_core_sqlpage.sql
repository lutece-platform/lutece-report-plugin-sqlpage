...
('SQLPAGE_MANAGEMENT','sqlpage.adminFeature.ManageSQLPage.name',1,'jsp/admin/plugins/sqlpage/ManageSQLFragments.jsp','sqlpage.adminFeature.ManageSQLPage.description',0,'sqlpage',NULL,NULL,NULL,4);
